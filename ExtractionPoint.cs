...
{
	// Token: 0x06000792 RID: 1938 RVA: 0x00047858 File Offset: 0x00045A58
	private void Start()
	{
	...
	// Token: 0x06000793 RID: 1939 RVA: 0x00047AB1 File Offset: 0x00045CB1
	...
	// Token: 0x06000794 RID: 1940 RVA: 0x00047AC0 File Offset: 0x00045CC0
	public void ActivateTheFirstExtractionPointAutomaticallyWhenAPlayerLeaveTruck()
	{
		this.OnClick();
	}

	// Token: 0x06000795 RID: 1941 RVA: 0x00047AC8 File Offset: 0x00045CC8
	public void OnClick()
	{
		if (this.isLocked)
		{
	...
	// Token: 0x06000796 RID: 1942 RVA: 0x00047B54 File Offset: 0x00045D54
	...
	// Token: 0x06000797 RID: 1943 RVA: 0x00047B68 File Offset: 0x00045D68
	...
	// Token: 0x06000798 RID: 1944 RVA: 0x00047BCF File Offset: 0x00045DCF
	...
	// Token: 0x06000799 RID: 1945 RVA: 0x00047BE8 File Offset: 0x00045DE8
	...
	// Token: 0x0600079A RID: 1946 RVA: 0x00047C44 File Offset: 0x00045E44
	...
	// Token: 0x0600079B RID: 1947 RVA: 0x00047C84 File Offset: 0x00045E84
	...
	// Token: 0x0600079C RID: 1948 RVA: 0x00047D64 File Offset: 0x00045F64
	...
	// Token: 0x0600079D RID: 1949 RVA: 0x00047E30 File Offset: 0x00046030
	...
	// Token: 0x0600079E RID: 1950 RVA: 0x00047EB8 File Offset: 0x000460B8
	private void HaulGoalSet(int value)
	{
		...
		{
			this.HaulGoalSetRPC(value);
		}
	}

	// Token: 0x0600079F RID: 1951 RVA: 0x00047EF0 File Offset: 0x000460F0
	[PunRPC]
	...
	// Token: 0x060007A0 RID: 1952 RVA: 0x00047F0C File Offset: 0x0004610C
	...
	// Token: 0x060007A1 RID: 1953 RVA: 0x00047F70 File Offset: 0x00046170
	...
	// Token: 0x060007A2 RID: 1954 RVA: 0x00048090 File Offset: 0x00046290
	...
	// Token: 0x060007A3 RID: 1955 RVA: 0x000480F0 File Offset: 0x000462F0
	...
	// Token: 0x060007A4 RID: 1956 RVA: 0x000482C0 File Offset: 0x000464C0
	private void UpdateEmojiText()
	{
		if (this.haulCurrent == 0)
		{
			this.SetEmojiScreen("<sprite name=:'(>");
			if (this.isShop)
			{
				this.SetEmojiScreen("<sprite name=shoppingcart>");
				if (this.isThief)
				{
					this.SetEmojiScreen("<sprite name=thief>");
					return;
				}
			}
		}
		else
		{
			...
			this.SetEmojiScreen(array[num2]);
		}
	}

	// Token: 0x060007A5 RID: 1957 RVA: 0x000483AC File Offset: 0x000465AC
	...
	// Token: 0x060007A6 RID: 1958 RVA: 0x00048404 File Offset: 0x00046604
	private void Update()
	{
		...
		{
			foreach (PhysGrabber physGrabber in this.buttonGrabObject.playerGrabbing.ToList<PhysGrabber>())
			{
				if (!SemiFunc.IsMultiplayer())
				{
	...
	// Token: 0x060007A7 RID: 1959 RVA: 0x00048794 File Offset: 0x00046994
	...
	// Token: 0x060007A8 RID: 1960 RVA: 0x0004888C File Offset: 0x00046A8C
	...
	// Token: 0x060007A9 RID: 1961 RVA: 0x00049184 File Offset: 0x00047384
	...
	// Token: 0x060007AA RID: 1962 RVA: 0x0004921C File Offset: 0x0004741C
	private void SetHaulText()
	{
		if (!this.isShop)
		{
			string str = "<color=#bd4300>$</color>";
			this.haulGoalScreen.text = str + SemiFunc.DollarGetString(Mathf.Max(0, this.haulCurrent));
			this.haulBarTargetScale = (float)this.haulCurrent / (float)this.haulGoal;
			return;
		}
		string str2 = "<color=#bd4300>$</color>";
		this.haulGoalScreen.text = str2 + SemiFunc.DollarGetString(this.haulGoal - this.haulCurrent);
	...
	// Token: 0x060007AB RID: 1963 RVA: 0x000492D8 File Offset: 0x000474D8
	...
	// Token: 0x060007AC RID: 1964 RVA: 0x00049324 File Offset: 0x00047524
	...
	// Token: 0x060007AD RID: 1965 RVA: 0x000493A0 File Offset: 0x000475A0
	private void StateSuccess()
	{
		...
		if (this.stateStart)
		{
			...
			this.stateStart = false;
			this.SetEmojiScreen("<sprite name=check>");
	...
	// Token: 0x060007AE RID: 1966 RVA: 0x000495B8 File Offset: 0x000477B8
	private void StateSurplus()
	{
		...
		if (this.stateStart)
		{
			...
			this.ResetLightIntensity();
			this.SetSpotlightColor(Color.green);
			this.SetEmojiScreen("<sprite name=surplus>");
			this.emojiLight.color = Color.green;
			this.EmojiScreenGlitch(Color.green);
			this.emojiDelay = 0f;
			this.tubeSlamDownEval = 0f;
		...
		if (this.stateTimer < this.initialStateTime - num)
		{
			...
			else if (!this.haulSurplusAnimatedDone && this.initialStateTime != 0f)
			{
				...
				this.SetEmojiScreen("<sprite name=moneyeyes>");
				GameDirector.instance.CameraImpact.ShakeDistance(5f, 3f, 8f, this.haulGoalScreen.transform.position, 0.1f);
				GameDirector.instance.CameraShake.ShakeDistance(5f, 3f, 8f, this.haulGoalScreen.transform.position, 0.1f);
	...
	// Token: 0x060007AF RID: 1967 RVA: 0x00049ADC File Offset: 0x00047CDC
	...
	// Token: 0x060007B0 RID: 1968 RVA: 0x00049BF8 File Offset: 0x00047DF8
	...
	// Token: 0x060007B1 RID: 1969 RVA: 0x00049C89 File Offset: 0x00047E89
	...
	// Token: 0x060007B2 RID: 1970 RVA: 0x00049CC0 File Offset: 0x00047EC0
	...
	// Token: 0x060007B3 RID: 1971 RVA: 0x00049F44 File Offset: 0x00048144
	...
	// Token: 0x060007B4 RID: 1972 RVA: 0x00049F94 File Offset: 0x00048194
	private void StateCancel()
	{
		...
		if (this.stateStart)
		{
			this.ShopButtonPushVisualsStart();
			this.taxReturn = false;
			this.SetEmojiScreen("<sprite name=X>");
			this.emojiLight.color = Color.red;
			this.emojiLight.intensity = this.emojiLightIntensity;
			this.haulGoalScreen.color = Color.red;
			this.ResetLights();
	...
	// Token: 0x060007B5 RID: 1973 RVA: 0x0004A308 File Offset: 0x00048508
	private void StateExtracting()
	{
		...
		if (this.stateStart)
		{
			...
			this.ResetLights();
			this.stateTimer = 5f;
			this.SetEmojiScreen("<sprite name=creepycrying>");
			this.tubeHit = false;
			this.stateStart = false;
			this.cancelExtraction = false;
	...
	// Token: 0x060007B6 RID: 1974 RVA: 0x0004AA20 File Offset: 0x00048C20
	...
	// Token: 0x060007B7 RID: 1975 RVA: 0x0004AA98 File Offset: 0x00048C98
	...
	// Token: 0x060007B8 RID: 1976 RVA: 0x0004ABC8 File Offset: 0x00048DC8
	...
	// Token: 0x060007B9 RID: 1977 RVA: 0x0004AE60 File Offset: 0x00049060
	...
	// Token: 0x060007BA RID: 1978 RVA: 0x0004B2DC File Offset: 0x000494DC
	private void ExtractionPointSurplus()
	{
		...
		else
		{
			...
			this.ExtractionPointSurplusRPC(surplus);
		}
	}

	// Token: 0x060007BB RID: 1979 RVA: 0x0004B330 File Offset: 0x00049530
	...
	// Token: 0x060007BC RID: 1980 RVA: 0x0004B354 File Offset: 0x00049554
	...
	// Token: 0x060007BD RID: 1981 RVA: 0x0004B43F File Offset: 0x0004963F
	[PunRPC]
	...
	// Token: 0x060007BE RID: 1982 RVA: 0x0004B44C File Offset: 0x0004964C
	private void StateSet(ExtractionPoint.State newState)
	{
		...
		{
			this.settingState = true;
			this.StateSetRPC(newState);
		}
	}

	// Token: 0x060007BF RID: 1983 RVA: 0x0004B4B6 File Offset: 0x000496B6
	[PunRPC]
	public void StateSetRPC(ExtractionPoint.State state)
	{
	...
	// Token: 0x060007C0 RID: 1984 RVA: 0x0004B4D1 File Offset: 0x000496D1
	private bool StateIs(ExtractionPoint.State state)
	{
		return this.currentState == state;
	}

	// Token: 0x060007C1 RID: 1985 RVA: 0x0004B4DC File Offset: 0x000496DC
	...
	// Token: 0x060007C2 RID: 1986 RVA: 0x0004B590 File Offset: 0x00049790
	...
	// Token: 0x060007C3 RID: 1987 RVA: 0x0004B65C File Offset: 0x0004985C
	...
	// Token: 0x060007C4 RID: 1988 RVA: 0x0004B7E0 File Offset: 0x000499E0
	...
	// Token: 0x060007C5 RID: 1989 RVA: 0x0004B8C0 File Offset: 0x00049AC0
	...
	// Token: 0x060007C6 RID: 1990 RVA: 0x0004B940 File Offset: 0x00049B40
	...
	// Token: 0x060007C7 RID: 1991 RVA: 0x0004B9C8 File Offset: 0x00049BC8
	...
	// Token: 0x060007C8 RID: 1992 RVA: 0x0004BA6C File Offset: 0x00049C6C
	[PunRPC]
