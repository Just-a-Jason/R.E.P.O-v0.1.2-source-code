...
{
	// Token: 0x06000366 RID: 870 RVA: 0x00021665 File Offset: 0x0001F865
	private void Awake()
	{
	...
	// Token: 0x06000367 RID: 871 RVA: 0x00021694 File Offset: 0x0001F894
	private void Update()
	{
	...
	// Token: 0x06000368 RID: 872 RVA: 0x00021868 File Offset: 0x0001FA68
	...
	// Token: 0x06000369 RID: 873 RVA: 0x000218B8 File Offset: 0x0001FAB8
	...
	// Token: 0x0600036A RID: 874 RVA: 0x00021960 File Offset: 0x0001FB60
	...
	// Token: 0x0600036B RID: 875 RVA: 0x00021AEC File Offset: 0x0001FCEC
	...
	// Token: 0x0600036C RID: 876 RVA: 0x00021B3D File Offset: 0x0001FD3D
	...
	// Token: 0x0600036D RID: 877 RVA: 0x00021B54 File Offset: 0x0001FD54
	...
	// Token: 0x0600036E RID: 878 RVA: 0x00021C6C File Offset: 0x0001FE6C
	...
	// Token: 0x0600036F RID: 879 RVA: 0x00021D48 File Offset: 0x0001FF48
	...
	// Token: 0x06000370 RID: 880 RVA: 0x00021E44 File Offset: 0x00020044
	...
	// Token: 0x06000371 RID: 881 RVA: 0x00022198 File Offset: 0x00020398
	...
	// Token: 0x06000372 RID: 882 RVA: 0x00022240 File Offset: 0x00020440
	...
	// Token: 0x06000373 RID: 883 RVA: 0x000222D4 File Offset: 0x000204D4
	...
	// Token: 0x06000374 RID: 884 RVA: 0x00022469 File Offset: 0x00020669
	public void OnSpawn()
	{
	...
	// Token: 0x06000375 RID: 885 RVA: 0x00022488 File Offset: 0x00020688
	public void OnHurt()
	{
	...
	// Token: 0x06000376 RID: 886 RVA: 0x000224E0 File Offset: 0x000206E0
	public void OnDeath()
	{
	...
	// Token: 0x06000377 RID: 887 RVA: 0x000225D4 File Offset: 0x000207D4
	public void OnInvestigate()
	{
		if (SemiFunc.IsMasterClientOrSingleplayer() && this.enemy.Rigidbody.timeSinceStun > 1.5f)
		{
			if (this.currentState == EnemyHunter.State.Idle || this.currentState == EnemyHunter.State.Roam || this.currentState == EnemyHunter.State.InvestigateWalk || (this.currentState == EnemyHunter.State.ShootEnd && this.shotsFired < this.shotsFiredMax) || (this.currentState == EnemyHunter.State.Leave && this.leaveInterruptCounter >= 3))
			{
				...
				if (Vector3.Distance(this.investigatePoint, base.transform.position) < 4f)
				{
					this.shootFast = true;
				}
				else
	...
	// Token: 0x06000378 RID: 888 RVA: 0x00022714 File Offset: 0x00020914
	...
	// Token: 0x06000379 RID: 889 RVA: 0x00022808 File Offset: 0x00020A08
	...
	// Token: 0x0600037A RID: 890 RVA: 0x000228E8 File Offset: 0x00020AE8
	...
	// Token: 0x0600037B RID: 891 RVA: 0x000229DC File Offset: 0x00020BDC
	...
	// Token: 0x0600037C RID: 892 RVA: 0x00022A48 File Offset: 0x00020C48
	...
	// Token: 0x0600037D RID: 893 RVA: 0x00022D9C File Offset: 0x00020F9C
	...
	// Token: 0x0600037E RID: 894 RVA: 0x00022F18 File Offset: 0x00021118
	...
	// Token: 0x0600037F RID: 895 RVA: 0x00022F7C File Offset: 0x0002117C
	...
	// Token: 0x06000380 RID: 896 RVA: 0x0002309A File Offset: 0x0002129A
	...
	// Token: 0x06000381 RID: 897 RVA: 0x000230DC File Offset: 0x000212DC
	...
	// Token: 0x06000382 RID: 898 RVA: 0x0002314A File Offset: 0x0002134A
	...
	// Token: 0x06000383 RID: 899 RVA: 0x00023168 File Offset: 0x00021368
	...
	// Token: 0x06000384 RID: 900 RVA: 0x00023262 File Offset: 0x00021462
	...
	// Token: 0x06000385 RID: 901 RVA: 0x000232A1 File Offset: 0x000214A1
	[PunRPC]
	private void UpdateStateRPC(EnemyHunter.State _state)
	{
		this.currentState = _state;
	...
	// Token: 0x06000386 RID: 902 RVA: 0x000232BD File Offset: 0x000214BD
	[PunRPC]
	...
	// Token: 0x06000387 RID: 903 RVA: 0x000232C8 File Offset: 0x000214C8
	[PunRPC]
	...
	// Token: 0x06000388 RID: 904 RVA: 0x000235C4 File Offset: 0x000217C4
	[PunRPC]
