...
{
	// Token: 0x060002B4 RID: 692 RVA: 0x0001B6FC File Offset: 0x000198FC
	private void Awake()
	{
	...
	// Token: 0x060002B5 RID: 693 RVA: 0x0001B781 File Offset: 0x00019981
	...
	// Token: 0x060002B6 RID: 694 RVA: 0x0001B790 File Offset: 0x00019990
	private void Update()
	{
		if (!this.setup)
		{
		...
		if (this.debugDraw)
		{
			if (this.currentState == EnemyGnomeDirector.State.Idle)
			{
				...
				using (List<EnemyGnome>.Enumerator enumerator = this.gnomes.GetEnumerator())
				{
					...
					{
						EnemyGnome item = enumerator.Current;
						Debug.DrawRay(this.destinations[this.gnomes.IndexOf(item)], Vector3.up * 2f, Color.yellow);
					}
					goto IL_CA;
				}
			}
	...
	// Token: 0x060002B7 RID: 695 RVA: 0x0001B8D8 File Offset: 0x00019AD8
	...
	// Token: 0x060002B8 RID: 696 RVA: 0x0001B974 File Offset: 0x00019B74
	...
	// Token: 0x060002B9 RID: 697 RVA: 0x0001B9CC File Offset: 0x00019BCC
	...
	// Token: 0x060002BA RID: 698 RVA: 0x0001BA4C File Offset: 0x00019C4C
	...
	// Token: 0x060002BB RID: 699 RVA: 0x0001BA64 File Offset: 0x00019C64
	...
	// Token: 0x060002BC RID: 700 RVA: 0x0001BB18 File Offset: 0x00019D18
	...
	// Token: 0x060002BD RID: 701 RVA: 0x0001BBE0 File Offset: 0x00019DE0
	...
	// Token: 0x060002BE RID: 702 RVA: 0x0001BDB0 File Offset: 0x00019FB0
	...
	// Token: 0x060002BF RID: 703 RVA: 0x0001BDCC File Offset: 0x00019FCC
	private bool SetPosition(Vector3 _initialPosition)
	{
		...
		})) && !SemiFunc.EnemyPhysObjectSphereCheck(navMeshHit.position, 1f))
		{
			...
			foreach (EnemyGnome item in this.gnomes)
			{
				float num2 = 0f;
				...
				this.destinations[this.gnomes.IndexOf(item)] = value;
	...
	// Token: 0x060002C0 RID: 704 RVA: 0x0001C03C File Offset: 0x0001A23C
	...
	// Token: 0x060002C1 RID: 705 RVA: 0x0001C074 File Offset: 0x0001A274
	...
	// Token: 0x060002C2 RID: 706 RVA: 0x0001C0CD File Offset: 0x0001A2CD
	...
	// Token: 0x060002C3 RID: 707 RVA: 0x0001C0E4 File Offset: 0x0001A2E4
	...
	// Token: 0x060002C4 RID: 708 RVA: 0x0001C1F8 File Offset: 0x0001A3F8
	...
	// Token: 0x060002C5 RID: 709 RVA: 0x0001C258 File Offset: 0x0001A458
	...
	// Token: 0x060002C6 RID: 710 RVA: 0x0001C2C0 File Offset: 0x0001A4C0
	public void OnSpawn()
	{
		foreach (EnemyGnome enemyGnome in this.gnomes)
		{
